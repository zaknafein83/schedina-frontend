...
import { CalendarDays, FileText, Coins, Trophy, User, LogOut, ChevronRight, HelpCircle, Menu, X, BookOpen } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/mod/rules',     label: 'Regole',     icon: BookOpen },
