  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gds-dark">Listini</h1>
      </div>
      ...
      <div className="flex gap-1 mb-4 border-b border-gray-200">
        <button
          ...
          className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
            tab === 'teams' ? 'border-gds-pink text-gds-pink' : 'border-transparent text-gds-gray hover:text-gds-dark'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
            tab === 'players' ? 'border-gds-pink text-gds-pink' : 'border-transparent text-gds-gray hover:text-gds-dark'
          }`}
        >
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 mb-4 grid grid-cols-1 md:grid-cols-3 gap-3">
        <div>
          <label className="text-sm font-medium text-gds-dark block mb-1">Lega</label>
          <select
            value={leagueFilter}
        ...
        {tab === 'players' && (
          <>
            <div>
              <label className="text-sm font-medium text-gds-dark block mb-1">Squadra</label>
              <select
                value={teamFilter}
            ...
            <div>
              <label className="text-sm font-medium text-gds-dark block mb-1">Ruolo</label>
              <select
                value={roleFilter}
