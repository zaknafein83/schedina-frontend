...
export default function Rules() {
  ...
  function openCreate() {
    setEditing(null)
    reset({ name: '', winningThresholds: '9, 10, 11, 12, 13', isActive: true })
    setModalOpen(true)
  }
  function openEdit(r) {
    setEditing(r)
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gds-gray mb-4">
        ...
        I <strong>premi</strong> si impostano sul singolo <strong>Concorso</strong> (separati per Totocalcio
        e Under/Over). Le giornate/concorsi riusano le regole.
      </p>
